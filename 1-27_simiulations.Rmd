...
c(df, f, n, n_train, p,
    ...
    test_df, test_covs, test_control, test_treated, 
    n_test_control, n_test_treated, 
    bart_fit, counterfactuals) %<-% estimator_inputs(df, 100, 200, 'xgb')
HTE_test_treated = HTE[test_treated]

## Predict using others
ftrue1 = y_dgp(df[test_treated, 1:2], 1, 0)
ftrue0 = y_dgp(df[test_treated, 1:2], 0, 0)
mean(abs((ftrue1 - ftrue0) - HTE_test_treated))
